<div>
    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                <h4 style="color: blue">Registro de cobranza mutual y otros</h4>
                ...
                <div class="col-lg-2 col-md-8">
                    @if ($cobrador_id != null)
                        <button type="button" id="btnNuevo" class="btn btn-success" data-toggle="tooltip"
                            ...
                            wire:loading.attr="disabled">Nuevo
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-control custom-switch">
                                    @if (auth()->user()->hcerol_id == 1)
                                        <input type="checkbox" class="custom-control-input" name="vida"
                                            wire:model="vida" id="vida"
                                            @if ($vida == 1) checked @endif>
                                    @else
                                        <input type="checkbox" class="custom-control-input" name="vida"
                                            wire:model="vida" id="vida" disabled
                                            @if ($vida == 1) checked @endif>
                                    @endif
                                    <label class="custom-control-label" style="color: blue"
                                        for="vida">Vigilia</label>
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <script>
        document.addEventListener('livewire:load', function() {
            ...
            Livewire.on('confirmar-borrar-mutual', entregaId => {
                Swal.fire({
                    title: '¿Está seguro?',
